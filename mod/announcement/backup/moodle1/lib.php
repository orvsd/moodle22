...
class moodle1_mod_announcement_handler extends moodle1_mod_handler {
    ...
    public function process_announcement($data) {
        ...
        $fileman = $this->converter->get_file_manager($contextid, 'mod_announcement');
        ...
        // write inforef.xml
        $this->open_xml_writer("activities/announcement_{$moduleid}/inforef.xml");
        ...
        // write announcement.xml
        $this->open_xml_writer("activities/announcement_{$moduleid}/announcement.xml");
        $this->xmlwriter->begin_tag('activity', array('id' => $instanceid, 'moduleid' => $moduleid,
            'modulename' => 'announcement', 'contextid' => $contextid));
        $this->write_xml('announcement', $data, array('/announcement/id'));
