...
//===== 1.9.0 upgrade line ======//
    ...
    /// Rename field content on table announcement to intro
    ...
    /// announcement savepoint reached
        upgrade_mod_savepoint(true, 2009042200, 'announcement');
    }
    ...
    /// Launch add field introformat
        ...
        $DB->set_field('announcement', 'introformat', FORMAT_HTML, array());

    /// announcement savepoint reached
        upgrade_mod_savepoint(true, 2009042201, 'announcement');
    }
