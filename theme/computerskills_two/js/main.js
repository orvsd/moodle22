...
function initBalls(){
    ...
    // i
    var oOffset = 67;
    balls.push(new Ball(oOffset + 215, 11, 0, 0, yellow));
    balls.push(new Ball(oOffset + 215, 37, 0, 0, yellow));
    balls.push(new Ball(oOffset + 215, 48, 0, 0, yellow));
    balls.push(new Ball(oOffset + 215, 58, 0, 0, yellow));
    balls.push(new Ball(oOffset + 215, 70, 0, 0, yellow));
