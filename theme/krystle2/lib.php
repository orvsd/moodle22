 ...
 * @return string
 */
function krystle2_process_css($css, $theme) {
    ...
    $css = krystle2_set_backgroundcolor($css, $backgroundcolor);
    ...
    $css = krystle2_set_customcss($css, $customcss);
 ...
 * @return string
 */
function krystle2_set_backgroundcolor($css, $backgroundcolor) {
 ...
 * @return string
 */
function krystle2_set_customcss($css, $customcss) {
...
function krystle2_require_course_login($courseorid, $autologinguest = true, $cm = NULL, $setwantsurltome = true, $preventredirect = true) {
    global $CFG, $SITE;
    ...
    if (!empty($CFG->forcelogin)) {
        ...
        krystle2_require_login($courseorid, $autologinguest, $cm, $setwantsurltome, $preventredirect);
...
function krystle2_require_login($courseorid = NULL, $autologinguest = true, $cm = NULL, $setwantsurltome = true, $preventredirect = false) {
...
class krystle2_expand_navigation extends global_navigation {
...
class krystle2_dummy_page extends moodle_page {
    /**
