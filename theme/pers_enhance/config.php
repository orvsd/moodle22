...
$THEME->name = 'pers_enhance';

$THEME->sheets = array('base', 'skonline','browser', 'ImportedFromMoodle1_9', 'CoursesSitewide', 'pers_enhance');
...
$THEME->parents_exclude_sheets = array('skonline', 'base'=>array('styles_moz'));
