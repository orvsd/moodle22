...
$THEME->sheets = array('base', 'skonline', 'browser', 'ImportedFromMoodle1_9', 'CoursesSitewide');
...
$THEME->javascripts = array('skonline');
$THEME->javascripts_footer = array('jquery-1.7.2.min', 'jquery-extendend-selectors');