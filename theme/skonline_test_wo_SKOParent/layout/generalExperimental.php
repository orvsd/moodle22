...
<body id="<?php echo $PAGE->bodyid ?>" class="<?php echo $PAGE->bodyclasses.' '.join(' ', $bodyclasses) ?>" onload="mydefaultsize()">
                    ...
                    <div id="region-main">
                        <div class="region-content">
                           <?php echo core_renderer::MAIN_CONTENT_TOKEN ?>
							...
							<?php echo '<a href="' . $CFG->wwwroot . '/course/view.php?id=' . $COURSE->id . '">Back to Main Page</a>'; ?>	
                        </div>
                    </div>
                </div>
