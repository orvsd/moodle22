...
$THEME->name = 'soph_survey_lit';

$THEME->sheets = array('base', 'skonline', 'browser', 'ImportedFromMoodle1_9', 'CoursesSitewide', 'soph_survey_lit');
...
$THEME->javascripts = array('skonline' => array('skonline'), 'jquery-1.7.2.min', 'jquery.iframe-auto-height.plugin.1.6.0');
