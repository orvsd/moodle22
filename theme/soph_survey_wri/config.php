...
$THEME->name = 'soph_survey_wri';

$THEME->sheets = array('base', 'skonline', 'browser', 'ImportedFromMoodle1_9', 'CoursesSitewide', 'soph_survey_wri', 'http://fonts.googleapis.com/css?family=Shadows+Into+Light+Two');
